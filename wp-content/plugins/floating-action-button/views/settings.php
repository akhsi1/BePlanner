            ...
            <table class="widefat fz-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="fz-td-2">
                            <button id="fz-fab-main-btn-icon" data-id="<?php echo $main_img_id; ?>" class="button button-small button-seconday">
                        ...
                        <td rowspan="3" style="vertical-align: middle;">
                            <img src="<?php echo $main_img_src; ?>" id="fz-fab-main-btn-preview-img" style="background-color: <?php echo $main_bg_color; ?>; color: <?php echo $main_color; ?>;">
                        </td>
                    </tr>
                    <tr>
                        <td class="fz-td-1">
                        ...
                        <td class="fz-td-2">
                            <input id="fz-fab-main-btn-color" value="<?php echo $main_color; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td class="fz-td-1">
                        ...
                        <td class="fz-td-2">
                            <input id="fz-fab-main-btn-bg-color" value="<?php echo $main_bg_color; ?>">
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <?php if(is_array($fz_fab_sub_btns) && count($fz_fab_sub_btns) > 0): ?>
                        <?php foreach($fz_fab_sub_btns as $fz_fab_sub_btn): ?>
                            ...
                            <tr data-type="<?php echo $type; ?>">
                                <td>
                                    <div style="font-weight: bold;"><?php echo strtoupper($type); ?></div>
                                    <input class="fz-fab-sub-btn-titles" value="<?php echo $title; ?>">
                                </td>
                                <td>
                                    <textarea class="fz-fab-sub-btn-contents"><?php echo $content; ?></textarea>
                                </td>
                                <td>
                                    <button data-id="<?php echo $img_id; ?>" class="button button-small button-secondary fz-fab-sub-btn-icons">
                                        <?php _e('Select Icon', 'floating-action-button'); ?>
                                    </button>
                                    <small class="fz-fab-small"><?php _e('Size 128x128 px', 'floating-action-button'); ?></small>
                                </td>
                                <td>
                                    <input class="fz-fab-sub-btn-colors" value="<?php echo $color; ?>">
                                </td>
                                <td>
                                    <input class="fz-fab-sub-btn-bg-colors" value="<?php echo $bg_color; ?>">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <img class="fz-fab-sub-btn-preview-img" src="<?php echo $image_src; ?>" style="background-color: <?php echo $bg_color; ?>; color: <?php echo $color; ?>;">
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>	
