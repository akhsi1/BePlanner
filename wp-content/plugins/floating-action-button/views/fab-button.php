...
<nav class="fz-fab-container"> 
	<?php if($position == '1' || $position == '2'): ?>
	    <a href="javascript: void(0);" class="fz-fab-buttons fz-fab-primary" style="display: none; background-color: <?php echo $main_bg_color; ?> !important; color: <?php echo $main_color; ?> !important;">
	...
	<?php if(is_array($fz_fab_sub_btns) && count($fz_fab_sub_btns) > 0): ?>
		<?php foreach($fz_fab_sub_btns as $i => $fz_fab_sub_btn): ?>
            ...
            ?>
            <a id="fz-fab-btn-<?php echo $i; ?>" data-id="<?php echo $i; ?>" title="<?php echo $title; ?>" href="javascript: void(0);" class="fz-fab-buttons fz-fab-secondary">
                <img src="<?php echo $image_src; ?>" style="color: <?php echo $color; ?> !important; background-color: <?php echo $bg_color; ?> !important;">
			</a>
		<?php endforeach; ?>	
	<?php endif; ?>	
    ...
    <?php foreach($fz_fab_sub_btns as $i => $fz_fab_sub_btn): ?>
        ...
        <?php else: ?>    
            <div data-id="<?php echo $i; ?>" class="fz-fab-box">
                <div class="fz-fab-box-head" style="background-color: <?php echo $bg_color; ?>; color: <?php echo $color; ?>; position: relative;">
                    <div style="display: inline-block; width: 30px;">
                        <span style="position: absolute; display: block; background-image: url('<?php echo $image_src; ?>'); width: 27px; height: 27px; background-size: cover; background-repeat: no-repeat; background-position: center; margin-top: -20px;"></span>
                    </div>
                ...
                <div class="fz-fab-body" style="padding: 20px; font-family: courier;">
                    <?php if($type == 'whatsapp'): ?>
                        ...
                        <div style="color: <?php echo $bg_color; ?>; text-align: center; font-size: 18px;">
                            <a href="<?php echo $whatsapp_url; ?>" target="_blank" style="padding: 10px 15px; border-radius: 3px; background-color: <?php echo $bg_color; ?>; color: <?php echo $color; ?>; text-decoration: none;">
                    ...
                    <?php elseif($type == 'phone'): ?>
                        <a href="tel:<?php echo str_replace(' ', '-', $content); ?>" style="display: block; text-align: center; margin-top: 10px; font-size: 24px; color: <?php echo $bg_color; ?>;">
                            <?php esc_html_e($content, 'floating-action-button'); ?>
                        </a>
                    <?php elseif($type == 'email'): ?>
                        <a href="mailto:<?php esc_html_e($content, 'floating-action-button'); ?>" style="display: block; text-align: center; margin-top: 10px; font-size: 24px; color: <?php echo $bg_color; ?>;">
                            <?php esc_html_e($content, 'floating-action-button'); ?>
                        </a>
                    <?php elseif($type == 'viber'): ?>
                        <a href="http://chats.viber.com/<?php esc_html_e($content, 'floating-action-button'); ?>" onclick="window.open(this.href, 'targetWindow', 'toolbar=no, location=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=800, height=800'); return false;" style="display: block; text-align: center; margin-top: 10px; font-size: 24px; color: <?php echo $bg_color; ?>;">
                            <?php esc_html_e($content, 'floating-action-button'); ?>
                        </a>
                    <?php elseif($type == 'snapchat'): ?>
                        <div style="width: 300px; text-align: center;">
                            ...
                            <div style="display: block; text-align: center; margin-top: 10px; font-size: 24px; color: <?php echo $bg_color; ?>;">
                                <?php esc_html_e($content, 'floating-action-button'); ?>
                            </div>
                        </div>
