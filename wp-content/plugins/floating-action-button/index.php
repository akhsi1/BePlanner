...
add_action('wp_ajax_fz_fab_settings_save','fz_fab_settings_save');
add_action('wp_ajax_nopriv_fz_fab_settings_save','fz_fab_settings_save');
function fz_fab_settings_save(){
