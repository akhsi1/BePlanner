...
class YCE_Classic_Editor
{
	...
	public static function init_actions()
    {
		...
		if ($settings['allow-users']) {
			self::allowUsers($gutenberg, $settings);
		} else {
		...
		if ($gutenberg) {
			self::removeGutenbergSettings();
		}
	}

	public static function hideSettingsUi($settings)
    {
	...
	public static function allowUsers($gutenberg, $settings)
    {
        // Also used in Gutenberg.
    ...
    public static function removeGutenbergSettings()
    {
...
add_action('plugins_loaded', array('YCE_Classic_Editor', 'init_actions'));