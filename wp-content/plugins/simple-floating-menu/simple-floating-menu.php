            ...
            <div class="wrap">
                ...
                <div id="sfm-header">
                    ...
                    <div class="upgrade-pro-banner">
                        <a href="https://codecanyon.net/item/super-floating-and-fly-menu-sticky-side-one-page-navigator-offcanvas-menu-plugin-for-wordpress/30485289" target="_blank">
                ...
                <div id="sfm-form-wrap">
                    <form method="POST">
                        ...
                        <div id="tab-upgrade-pro" class="sfm-form-page">
                            <h2>Super Floating and Fly Menu - All in One Menu Plugin for WordPress</h2>
                            <p>Super Floating and Fly Menu (SFFM) is a WordPress menu plugin that provides the ultimate solution to enhance the navigation functionality of your website.</p>

                            <p>It allows you to add two of the most popular and trending menus (Floating and Fly Menu) to supercharge the web navigation and make it very easy for your visitors to crawl the web contents.</p>

                            <p>Super Floating and Fly Menu (SFFM) has out of box functionality to make use of the default WordPress menu to create your own highly standard menu. It is packed with attractive menu designs and powerful features to design astonishing navigators in less than 5 minutes.</p>

                            <h2>Use Super Floating and Fly Menu Plugin for Floating Menu</h2>
                            <p>Super Floating and Fly Menu has a flexible feature to build a multipurpose floating menu for WordPress. You can use it as a sticky navigator, social menu, or even one page scroller.</p>

                            <h2>Great Features Available for Floating Menu in Super Floating and Fly Menu</h2>
                            <ul>
                                <li>15 Pre Designed Menu Layouts</li>
                                <li>Awesome Menu Animation Effects</li>
                                <li>Different Menu Locations</li>
                                <li>Create Unlimited Floating Menus</li>
                                <li>Page Selection for Each Menus</li>
                                <li>12 Different Menu Positions</li>
                                ...
                                <li>Unlimited Color Options for Social Menus</li>
                                <li>Display Option for Desktop and Mobile</li>
                            </ul>

                            <h2>Use Super Floating and Fly Menu Plugin for FlyOut/Off Canvas Menu</h2>
                            <p>Alternatively, the Super Floating and Fly Menu allows you to create a flyout/off canvas menu on your WordPress website. A flyout/off canvas menu is a stylish menu type popular among the latest trends. It displays your web contents in beautiful animation effects to provide the best navigation experience.</p>

                            <h2>Great Features Available for Fly Menu in Super Floating and Fly Menu</h2>
                            <ul>
                                ...
                                <li>Color Customizations for Social Icons</li>
                            </ul>

                            <h2>Compatibility:</h2>
                            <p>Super Floating and Fly Menu (SFFM) is compatible with all types of WordPress themes. Just install the plugin after you have purchased it and start creating your navigation menu.</p>

                            <h2>Documentation:</h2>
                            <p>We have prepared extensive and detailed documentation for our plugin - Super Floating and Fly Menu (SFFM) which comprise a step by step guideline for the installation and configuration of the plugin. To view the documentation, click here.</p>
                            <p><a href="https://hashthemes.com/documentation/super-floating-and-fly-documentation/">https://hashthemes.com/documentation/super-floating-and-fly-documentation/</a></p>

                            <h2>Support:</h2>
                            <p>If you have any issues while using our plugin, feel free to contact us for support. Our support team will be more than happy to help you resolve your issue. You can create a support ticket from <a href="https://hashthemes.com/support/">here</a>.</p>

                            <p>
                                <div class="sfm-buy-link">
                                    <a href="https://codecanyon.net/item/super-floating-and-fly-menu-sticky-side-one-page-navigator-offcanvas-menu-plugin-for-wordpress/30485289" class="button" target="_blank">Buy</a>
                                </div>

                                <div class="sfm-demo-link">
                                    <a href="https://demo.hashthemes.com/super-floating-flying-menu/flymenu-fullside-menu-push/" class="button" target="_blank">Demo</a>
                                </div>
                            </p>
                        </div>
