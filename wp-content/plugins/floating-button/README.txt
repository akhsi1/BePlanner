...
Easily create a custom sticky floating buttons. The Floating Button will be the effective solution for increasing the recognition of your web resource
...
[Preview of Pro version](https://preview.wow-estore.com/floating-button-pro/)
...
= 4.0 =
* Updated: FontAwesom to 5.11.2
* Fixed: button output without sub-buttons

= 3.0 =
* Added: option for disable FontAwesome 5 from front-end;
* Updated: FontAwesom to 5.6.3
* Fixed: saving in data
...
= 2.0 =
* Added:change color for each button
* Added: link for LogIn, LogOut, Register, Lost password
* Changed: admin style
